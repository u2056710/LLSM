...
function [tracksFinal,kalmanInfoLink,errFlag] = trackgeneral(movieInfo)
...
%saveResults
%saveResults.dir = '/Users/u2056710/Desktop/results/'; %directory where to save input and output
%saveResults.filename = 'test.mat'; %name of file where input and output are saved
...
[tracksFinal,kalmanInfoLink,errFlag] = trackCloseGapsKalmanSparse(movieInfo,...
    costMatrices,gapCloseParam,kalmanFunctions,probDim,verbose);

%original code which includes save results
%[tracksFinal,kalmanInfoLink,errFlag] = trackCloseGapsKalmanSparse(movieInfo,...
