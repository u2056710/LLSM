function [movieInfo,exceptions,localMaxima,background,psfSigma] = trackdetect(imageDir, filenameBase, nfiles)
...
% 
% 
movieParam.imageDir = imageDir; %directory where images are
movieParam.filenameBase = filenameBase; %image file name base
movieParam.firstImageNum = 0002; %number of first image in movie
movieParam.lastImageNum = nfiles; %number of last image in movie
...
detectionParam.alphaLocMax = 0.0075; %alpha-value for initial detection of local maxima (original 0.001)
...
%saveResults
%saveResults.dir = uigetdir(pwd, 'Pick input directory'); %directory where to save input and output
